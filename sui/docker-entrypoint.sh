...
dasel put -f /opt/sui/config/node.yml -v 0 authority-store-pruning-config.num-epochs-to-retain
dasel put -f /opt/sui/config/node.yml -v 2 authority-store-pruning-config.num-epochs-to-retain-for-checkpoints
dasel put -f /opt/sui/config/node.yml -v 1 authority-store-pruning-config.periodic-compaction-threshold-days
dasel put -f /opt/sui/config/node.yml -v true authority-store-pruning-config.use-range-deletion
